...
EXAMEN: 90%
TAREAS: 10%
Nº DE TAREAS REALIZADAS 3

FÍSICA
EXAMEN:80%
TAREAS: 20%
Nº DE TAREAS REALIZADAS: 2
...
clase Scanner.**/
		...
		System.out.printf("En matemáticas,la media de las tareas es: %.2f, mientras que la media de la asignatura es: %.2f\n", mediatareas, mediamat);
		...
		System.out.printf("En física,la media de las tareas es: %.2f, mientras que la media de la asignatura es: %.2f\n", mediatareasf, mediaf);
		...
		System.out.printf("En Química,la media de las tareas es: %.2f, mientras que la media de la asignatura es: %.2f\n", mediatareasq, mediaq);
