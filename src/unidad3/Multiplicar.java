...
class Multiplicar {
	...
	public static void main(String[] args) {
		 ...
		 * resultado de cada multiplicación de la tabla elegida, contabilizando cada
		 * fallo y mostrando la respuesta correcta. Al completar la tabla, el programa
		 * le dirá al usuario si ha aprobado (menos de 2 fallos) o ha suspendido (2 o
		 * más fallos). Después finalizar el repaso de cada tabla, se dará la opción de
